...
public class FormServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String username = System.getenv("GMAIL_USERNAME"); // Variáveis de ambiente
        String password = System.getenv("GMAIL_PASSWORD"); // Usando senha de app
        ...
        try {
            ...
            response.getWriter().println("Erro ao enviar e-mail: " + e.getMessage());
        }
    }
}
